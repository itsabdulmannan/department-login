...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between flex-wrap bg-white text-white px-6 py-4 shadow-sm">
      {/* Toggle Sidebar Button */}
      <div
        onClick={handleSideBar}
        className="cursor-pointer relative z-30 text-lg bg-[#353372] px-4 py-2 rounded-md hover:bg-[#4c4b7e] focus:outline-none"
      >
